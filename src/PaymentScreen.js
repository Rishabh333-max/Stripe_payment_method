            ...
            return (
              <TouchableOpacity
                ...
                >
                  ...
                  <Text style={styles.text}>{item.last4}</Text>
                  </View>
                  <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                  <Text style={styles.text}>Card Brand:</Text>
                  <Text style={styles.text}>{item.brand}</Text>
                  </View>
                  <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                  <Text style={styles.text}>Card Expiry Month:</Text>
                  <Text style={styles.text}>{item.expiryMonth}</Text>
                  </View>
                  <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                  <Text style={styles.text}>Card Expiry Year:</Text>
                  <Text style={styles.text}>{item.expiryYear}</Text>
                  </View>
...
const styles=StyleSheet.create({
  text:{color: 'white',fontWeight:'600',marginHorizontal:20,marginVertical:5}
})
